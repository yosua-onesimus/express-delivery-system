 ...
 */
@Entity
@Table(name = "eds_routes")
@CCTypeConfig(label = "Route", uniqueKey = "name")
public class EdsRoute extends CCEntity {

    @ManyToOne
    @CCFieldConfig(group = "General", accessible = Accessible.MANDATORY, maxLength = 24, uniqueKey = "name")
    private EdsPath path;
    @Column(length = 8)
...
//<editor-fold defaultstate="collapsed" desc=" getter-setter ">
    public EdsPath getPath() {
        return path;
    }

    public void setPath(EdsPath path) {
        this.path = path;
    }
